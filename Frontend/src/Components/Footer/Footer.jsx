      ...
      <div className='footer-cont'>
        ...
        <div className='footer-text'>
          ...
          <div className='footer-line2'>
            ...
            <p><MdLocationPin className='footer-text-icon'/> <a href="https://www.google.com/maps/search/Traffic+Control+Sariab%09+Old+Bus+Stand+Satellite+Town+Quetta.%09+Old+Bus+Stand+Satellite+Town+Quetta.%09/@30.1793966,66.9598386,13z?entry=ttu&g_ep=EgoyMDI1MDEyMi4wIKXMDSoASAFQAw%3D%3D" target='_blank' rel="noreferrer">Quetta</a></p>
